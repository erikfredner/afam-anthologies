...
FIG_OUT_CUMULATIVE = Path(__file__).parent.parent / "viz" / "naaal2025_author_selection_logit_cumulative.png"
TARGET_YEAR = "2025"
TARGET_EDITION = "4"
...
def main() -> None:
    ...
    plot_probability_curve(authors, result, args.out_cumulative, cumulative=True)
