...
def compute_reselection_summary(df: pd.DataFrame):
    ...
    overall_odds = overall_p / (1 - overall_p) if 0 < overall_p < 1 else float('inf') if overall_p == 1 else 0.0
...
def main():
    ...
    # print overall stats
    print(f"Overall probability of work reselection across all editions: {overall_p:.4f}")
    print(f"Overall odds of work reselection across all editions:       {overall_odds:.4f}")
